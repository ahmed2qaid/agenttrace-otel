...
class AgentTraceSession:
    ...
    def record(
        ...
        *,
        ...
        event = TraceEvent(name=name, kind=kind, status=status, duration_ms=duration_ms, attributes=attrs)
        ...
        with self._tracer.start_as_current_span(
            ...
            attributes={
                ...
                "agenttrace.step.status": status,
                "agenttrace.duration_ms": duration_ms,
